		...
		btn_lieferantLoeschen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					try {
						...
						JOptionPane.showMessageDialog(btn_lieferantLoeschen, "Der Lieferant "+ lieferantenNr +" wurde gel�scht!");
						
					} catch (ArrayIndexOutOfBoundsException aoe) {
						JOptionPane.showMessageDialog( null ,"Wählen Sie zuerst einen Lieferanten in der Tabelle aus!");
					} catch (Exception e1) {
						JOptionPane.showMessageDialog( null ,"Wählen Sie zuerst einen Lieferanten in der Tabelle aus!");
					}finally {
						DBAccess d = new DBAccess();
